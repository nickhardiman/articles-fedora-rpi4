...
You need a 
https://www.raspberrypi.com/products/raspberry-pi-4-model-b/[Raspberry Pi 4 Model B]. 

You also need other things: definitely a power supply, data cables and storage devices, and possibly a keyboard, video and mouse. 
